"""Routes incoming Alexa commands to the appropriate module handlers."""
...
async def route_message(user_id: str, text: str, say) -> None:
    """Dispatch a command to the correct handler based on state or command text."""
    ...
    await say(
        f"I did not understand that command. "
        f"Say 'help' to hear available commands."
    )
