...
| **Filters** | {{ text\|upper }}           {# Convert to uppercase #}<br> {{ text\|lower }}           {# Convert to lowercase #} <br>{{ list\|length }}          {# Get length #} <br>{{ value\|default("default value") }}  {# Set default value #}<br> {{ number\|round(2) }}      {# Round #} | text: "Hello World" <br>list: ["a", "b", "c"] <br>number: 3.14159| HELLO <br>WORLD <br>hello world <br>3 <br>default value <br>3.14 |
