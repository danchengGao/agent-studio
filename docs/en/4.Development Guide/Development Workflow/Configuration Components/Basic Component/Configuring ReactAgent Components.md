...
| Skills | Tools available to the agent, including Plugins. The agent will autonomously decide which tools to use based on the task requirements. You can add multiple plugins as needed. |
